...
async function deleteCartItem(cartId) {
  // 請實作此函式
  const respons = await axios.delete(`${BASE_URL}/api/livejs/v1/customer/${API_PATH}/carts`,{
    data:{
      cartId
    }
    })
...
async function deleteOrder(orderId) {
  // 請實作此函式
  const response = await axios.delete(`${BASE_URL}/api/livejs/v1/admin/${API_PATH}/orders`,{
    data:{
      id:orderId
    },
    headers: {
